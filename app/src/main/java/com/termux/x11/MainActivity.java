...
public class MainActivity extends AppCompatActivity {
    ...
    private void setTerminalToolbarViewLayout() {
        handler.post(() -> {
            ...
            getLorieView().setContentInsets(pos == PAGER_POSITION_LEFT ? padding : 0, pos == PAGER_POSITION_TOP ? padding : 0, pos == PAGER_POSITION_RIGHT ? padding : 0, pos == PAGER_POSITION_BOTTOM ? padding : 0);
        });
    }
